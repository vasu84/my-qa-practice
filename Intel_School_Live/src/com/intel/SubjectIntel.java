...
public class SubjectIntel extends Login_Pgae_Intel {
	...
	public void Subject() throws InterruptedException, AWTException {
		...
		// delete topic
           driver.findElement(By.id("delete-topic")).click();
           Thread.sleep(500);
		...
		WebElement choosefile = driver.findElement(By.xpath("(//input[@autocomplete='off'])[23]"));
		Actions ac = new Actions(driver);
		ac.click(choosefile).build().perform();
		Thread.sleep(1000);
		...
		StringSelection str= new StringSelection("C:\\Drivers\\Raja Files\\Codes.xlsx");
