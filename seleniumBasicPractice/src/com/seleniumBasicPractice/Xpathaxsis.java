...
public class Xpathaxsis {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		           ...
		           // selecting gender(female) by following xpath  
		driver.findElement(By.xpath("//input[@value='m']//following::input[1]")).click();
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//input[@value='m']//following::input[3]")).sendKeys("dytreyuf");
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//input[@value='m']//following::input[9]")).click();
		Thread.sleep(4000);
